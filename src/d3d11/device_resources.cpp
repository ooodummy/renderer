...
void renderer::d3d11_device_resources::create_device() {
	...
	DPRINTF("[+] Created device context ({})\n", fmt::ptr(device_context_.Get()));
	DPRINTF("[+] Created annotation ({})\n", fmt::ptr(annotation_.Get()));
}
