...
constexpr renderer::color_cmyka::operator renderer::color_rgba() const {
...
constexpr renderer::color_hex::operator renderer::color_rgba() const {
...
constexpr renderer::color_rgba::color_rgba(uint8_t r, uint8_t g, uint8_t b, uint8_t a) : r(r), g(g), b(b), a(a) {}

constexpr renderer::color_rgba::color_rgba(const glm::vec4& f) {
...
constexpr renderer::color_rgba::operator renderer::color_cmyka() const {
...
constexpr renderer::color_rgba::operator renderer::color_hex() const {
	return { static_cast<uint32_t>(
	((((a) & 0xff) << 24) | (((b) & 0xff) << 16) | (((g) & 0xff) << 8) | ((r) & 0xff))) };
}

constexpr renderer::color_rgba::operator renderer::color_hsla() const {
...
constexpr renderer::color_rgba::operator renderer::color_hsva() const {
	const auto fr = static_cast<float>(r) / 255.0f;
	const auto fg = static_cast<float>(g) / 255.0f;
	const auto fb = static_cast<float>(b) / 255.0f;
